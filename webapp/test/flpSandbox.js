		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cópia de Material",
									"targetURL": "#materialcopy-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"materialcopy-display": {
								"semanticObject": "materialcopy",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=materialcopy",
									"url": sap.ui.require.toUrl("materialcopy")
								}
							}
						}
					}
